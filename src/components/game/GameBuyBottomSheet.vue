...
<template>
  <Teleport to="body">
    <template v-if="modelValue">
      ...
      <section
        class="game-buy-sheet fixed inset-x-0 bottom-0 z-50 mx-auto flex max-h-[85dvh] max-w-md flex-col gap-4 overflow-y-auto rounded-t-3xl bg-base px-5 pb-5 pt-3"
        role="dialog"
        aria-modal="true"
